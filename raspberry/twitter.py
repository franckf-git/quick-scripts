...
OWM_APIKEY = "123456789123456789"

# TheMovieDb.org API key
TMDB_APIKEY = "123456789123456789"
...
def gif():
    ...
    datas = json.loads(urllib.urlopen("http://api.giphy.com/v1/gifs/random?api_key=dc6zaTOxFJmzCt&tag="+category).read())
